namespace iFMIS_BMS.Reports
{
    ...
    /// <summary>
    /// Summary description for BOIperOffice.
    /// </summary>
    public partial class BOIperOffice : Telerik.Reporting.Report
    {
        public BOIperOffice(int? year, int? month_, int? OfficeID, int? type_pgo)
        {
                                                  ...
                                                  on a.OOE_Name = d.OOEName " +
                                                     " WHERE  case when cast( SUBSTRING(a.[OBRNo], 1, 3) as varchar ) = '201' " +
                                                         " or cast( SUBSTRING(a.[OBRNo], 1, 3) as varchar ) = '101'  " +
                                                          ...
                                                          "else cast('20' + SUBSTRING(a.[OBRNo], 10, 2) as varchar )  " +
                                                          "end = '" + year + "' and  case when cast( SUBSTRING([OBRNo], 1, 3) as varchar ) = '201' " +
                                                          ...
                                                          "end = '" + month_ + "' and c.OfficeID = '" + OfficeID + "' and LEN(a.OBRNo) != 16 and a.[ActionCode]=1" +
                                                  ...
                                                  on a.OOE_Name = d.OOEName " +
                                                     " WHERE  case when cast( SUBSTRING(a.[OBRNo], 1, 3) as varchar ) = '201' " +
                                                         " or cast( SUBSTRING(a.[OBRNo], 1, 3) as varchar ) = '101'  " +
                                                          ...
                                                          "then  cast(SUBSTRING([OBRNo], 13, 2) as int ) " +
                                                          "else  cast(SUBSTRING([OBRNo], 3, 2) as int ) " +
                                                          "end = '" + month_ + "' and c.OfficeID = '" + OfficeID + "'and a.[ActionCode]=1 " +
                                                      " order by d.OOEID", con);
                    con.Open();
                    dt.Load(com.ExecuteReader());
                                                      ...
                                                      left join IFMIS.dbo.tbl_R_BMSObjectOfExpenditure as d
                                                       on a.OOE_Name = d.OOEName " +
                                                         ...
                                                         " or cast( SUBSTRING(a.[OBRNo], 1, 3) as varchar ) = '101'  " +
                                                          ...
                                                          "then  cast(SUBSTRING([OBRNo], 13, 2) as int ) " +
                                                          "else  cast(SUBSTRING([OBRNo], 3, 2) as int ) " +
                                                          "end = '" + month_ + "' and c.OfficeID = '" + OfficeID + "' and LEN(a.OBRNo) != 16 and a.[ActionCode]=1", con);
                    con.Open();
                                                      ...
                                                      left join IFMIS.dbo.tbl_R_BMSObjectOfExpenditure as d
                                                       on a.OOE_Name = d.OOEName " +
                                                         ...
                                                         " or cast( SUBSTRING(a.[OBRNo], 1, 3) as varchar ) = '101'  " +
                                                          ...
                                                          "then  cast(SUBSTRING([OBRNo], 13, 2) as int ) " +
                                                          "else  cast(SUBSTRING([OBRNo], 3, 2) as int ) " +
                                                          "end = '" + month_ + "' and c.OfficeID = '" + OfficeID + "' and a.[ActionCode]=1", con);
                    con.Open();
                    txt_todaydate.Value = "Date Printed : " + com.ExecuteScalar().ToString();

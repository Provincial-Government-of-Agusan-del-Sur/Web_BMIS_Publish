namespace iFMIS_BMS.Reports
{
    ...
    /// </summary>
    public partial class WFPNew_old : Telerik.Reporting.Report
    {
        public WFPNew_old(int year, int office, int project_id, int fundsource,string OfficeName,string ProjectName, string funddescription,int repHistory,int prepby,int printstatus,int projectaip,string fundsourcename,int accountID,string accountname,string  municipal,string barangay,string ooeclass,int pgas_loc)
        {
            //

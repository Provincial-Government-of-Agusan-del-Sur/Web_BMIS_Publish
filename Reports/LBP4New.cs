namespace iFMIS_BMS.Reports
{
    ...
    /// </summary>
    public partial class LBP4New : Telerik.Reporting.Report
    {
        //
        ...
        public LBP4New(int OfficeID, int YearOf, int isNonOffice,int reloadlbp4)
        {
            ...
            using (SqlConnection constr = new SqlConnection(Common.MyConn()))
            {
                ...
                while (reader.Read())
                {
                    ...
                    else
                    {
                        using (SqlConnection con = new SqlConnection(Common.MyConn()))
                        {
                            SqlCommand com2 = new SqlCommand(@"exec sp_BMS_LBP4 9999,9999,2", con);
                            con.Open();
                            dt.Load(com2.ExecuteReader());
                        }             

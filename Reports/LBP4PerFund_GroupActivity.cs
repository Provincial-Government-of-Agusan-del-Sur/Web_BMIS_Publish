namespace iFMIS_BMS.Reports
{
    ...
    /// </summary>
    public partial class LBP4PerFund_GroupActivity : Telerik.Reporting.Report
    {
        //
        ...
        public LBP4PerFund_GroupActivity(int OfficeID, int YearOf, int isNonOffice,int reloadlbp4)
        {

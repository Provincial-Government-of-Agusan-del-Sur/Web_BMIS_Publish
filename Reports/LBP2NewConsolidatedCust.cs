namespace iFMIS_BMS.Reports
{
    ...
    public partial class LBP2NewConsolidatedCust : Telerik.Reporting.Report
    {
        ...
        public LBP2NewConsolidatedCust(int OfficeID, int YearOf, int ReportTypeID, int includeLBP1, int pagnoid,long eid,int includezero,int reloadlbp2)
        {
            InitializeComponent();

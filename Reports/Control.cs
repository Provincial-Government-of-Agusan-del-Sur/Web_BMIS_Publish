namespace iFMIS_BMS.Reports
{
    ...
    /// </summary>
    public partial class Control : Telerik.Reporting.Report
    {
        public Control(int? OfficeID=0, int? year=0, string controlno="")
        {
            ...
            textBox8.Value = _dt2.Rows[0][0].ToString();
            textBox10.Value = _dt2.Rows[0][1].ToString();

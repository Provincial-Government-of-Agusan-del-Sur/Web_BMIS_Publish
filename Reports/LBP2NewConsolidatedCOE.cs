namespace iFMIS_BMS.Reports
{
    ...
    public partial class LBP2NewConsolidatedCOE : Telerik.Reporting.Report
    {
        ...
        public LBP2NewConsolidatedCOE(int OfficeID, int YearOf, int ReportTypeID, int includeLBP1, int pagnoid,long eid,int includezero,int reloadlbp2,int sectoral)
        {
            InitializeComponent();
            ...
            if (OfficeID == 0)
            {
                ...
                dt.Columns.Add("FundType");
                    ...
                    ReportType = ReportTypeID == 2 ? "Proposed" : "Expenditures (Proposed)";
                ...
                using (SqlConnection con = new SqlConnection(Common.MyConn()))
                {
                    ...
                    if (OfficeID == 39) //general fund
                    {
                        ...
                        string _sqlQuery = "select  " +
                                                "format(isnull(sum([PastYearApproved]), 0),'00,000.00')  " +
                                                ",format(isnull(sum([Current_Year_Obligated]), 0),'00,000.00') " +
                                                ",format(isnull(sum([CurrentYearApproved]), 0) - isnull(sum([Current_Year_Obligated]), 0),'00,000.00') " +
                                                ",format(isnull(sum([CurrentYearApproved]), 0),'00,000.00')  " +
                                                ",format(isnull(sum([BudgetYearAmount]), 0),'00,000.00')  " +
                                                ",format(isnull(sum([BudgetYearAmount]), 0) - isnull(sum([CurrentYearApproved]),0),'00,000.00') as [difference] " +
                                                "from tbl_R_BMSConsoliditedTotal " +
                                                "where YearOf = " + YearOf + " and OfficeID not in (37,38,41,105)";

                        _dt = OleDbHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings["sqldb"].ToString(), CommandType.Text, _sqlQuery).Tables[0];

                        textBox131.Value = "Total Appropriations - General Fund Proper";
                        textBox131.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox133.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox135.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox136.Style.BorderStyle.Right = Telerik.Reporting.Drawing.BorderType.Solid;
                        textBox137.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox139.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox141.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox143.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox143.Style.BorderStyle.Right = Telerik.Reporting.Drawing.BorderType.Solid;
                        ...
                        textBox144.Style.BorderStyle.Right = Telerik.Reporting.Drawing.BorderType.Solid;
                    }
                    else //econ
                    {
                        DataTable _dt = new DataTable();
                        ...
                        string _sqlQuery = "select  " +
                                                ...
                                                ",format(isnull(sum([BudgetYearAmount]), 0) - isnull(sum([CurrentYearApproved]),0),'00,000.00') as [difference] " +
                                                "from tbl_R_BMSConsoliditedTotal " +
                                                "where YearOf = " + YearOf + " and OfficeID  in (37,38,41)";

                        _dt = OleDbHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings["sqldb"].ToString(), CommandType.Text, _sqlQuery).Tables[0];

                        textBox131.Value = "Total Appropriations - Economic Enterprises";
                        textBox131.Style.BorderStyle.Top = Telerik.Reporting.Drawing.BorderType.Solid;
                        textBox131.Style.BorderStyle.Left = Telerik.Reporting.Drawing.BorderType.Solid;
                        textBox131.Style.BorderStyle.Bottom = Telerik.Reporting.Drawing.BorderType.Solid;
                        textBox133.Value = _dt.Rows[0][0].ToString();
       ...
       //     textBox1.Value = "Annual Budget CY " + YearOf + " - LBP Form No. 2";
            ...
            textBox114.Value = "Current Year Expenditures (Estimate) CY " + (YearOf - 1) + "";
            textBox96.Value = "Current Year Expenditures (Estimate) CY " + (YearOf - 1) + "";
            textBox110.Value = "CY " + (YearOf - 2) + "";
            textBox51.Value = "CY " + (YearOf - 2) + "";

            textBox57.Value = "CY " + YearOf + "";
            textBox69.Value = "CY " + YearOf + "";

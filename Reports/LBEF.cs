namespace iFMIS_BMS.Reports
{
    ...
    /// </summary>
    public partial class LBEF : Telerik.Reporting.Report
    {
        public LBEF(int? OfficeID, int? classtype, int? year, int? month_, int? batch, int? sort_, string note_, string ComputerIP)
        {

namespace iFMIS_BMS.Reports
{
    ...
    public partial class LBP2NewConsolidated2 : Telerik.Reporting.Report
    {
        ...
        public LBP2NewConsolidated2(int OfficeID, int YearOf, int ReportTypeID, int includeLBP1, int pagnoid,long eid,int includezero)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                else
                {
                    ...
                    using (SqlConnection con = new SqlConnection(Common.MyConn()))
                    {
                        SqlCommand com = new SqlCommand(@"sp_BMS_Get_LBP2Report " + OfficeID + ", " + YearOf + ", " + ReportTypeID + "," + eid + ","+ includezero + "", con);
                        con.Open();
                        dt.Load(com.ExecuteReader());
                        dt.Columns.Add("OfficeID");
                        dt.Columns.Add("OfficeName");
